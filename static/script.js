...
var urlParams = new URLSearchParams(window.location.search);
        ...
        // Your News API endpoint URL with the country code parameter
        var apiUrl = "https://newsapi.org/v2/top-headlines?country=" + countryCode + "&category=business&apiKey=0d5256f780a04156ba58cf7d772f1d41";
    ...
    function displayNews(articles) {
        ...
        if (articles && articles.length > 0) {
            ...
            articles.forEach(function(article) {
                ...
                articleElement.append("<p><strong>URL:</strong> <a href='" + article.url + "' target='_blank'>" + "click here to know more" + "</a></p>");
